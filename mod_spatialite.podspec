#
#  Be sure to run `pod spec lint mod_spatialite.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  A build of spatialite for iOS
                   DESC

  s.homepage     = "http://www.codenameone.com"
  ...
  s.author             = { "Steve Hannah" => "steve@weblite.ca" }
  # Or just: s.author    = "Steve Hannah"
  # s.authors            = { "Steve Hannah" => "steve@weblite.ca" }
  # s.social_media_url   = "http://twitter.com/Steve Hannah"
